                ...
                <%
                    ...
                    switch ((String) request.getAttribute("acao")) {
                        ...
                        case "incluir":
                            ...
                            %><jsp:include page="include/ControllerFornecedoresIncluir.jsp"/><%
                            break;

                        case "alterar":

                            %><jsp:include page="include/ControllerFornecedoresAlterar.jsp"/><%
                            break;

                        case "listar":

                            %><jsp:include page="include/ControllerFornecedoresListar.jsp"/><%
                            break;
