<%@ page import="java.util.ArrayList, app.Mensagem, model.Categoria" contentType="text/html;charset=UTF-8" %>
<!DOCTYPE html>
<html lang="pt-br">
                ...
                <%
                    ...
                    switch ((String) request.getAttribute("acao")) {
                        ...
                        case "incluir":
                            ...
                            %><jsp:include page="include/ControllerCategoriasIncluir.jsp"/><%
                            break;

                        case "alterar":

                            %><jsp:include page="include/ControllerCategoriasAlterar.jsp"/><%
                            break;

                        case "listar":

                            %><jsp:include page="include/ControllerCategoriasListar.jsp"/><%
                            break;
