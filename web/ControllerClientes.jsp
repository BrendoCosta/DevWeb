                ...
                <%
                    ...
                    switch ((String) request.getAttribute("acao")) {
                        ...
                        case "incluir":
                            ...
                            %><jsp:include page="include/ControllerClientesIncluir.jsp"/><%
                            break;

                        case "alterar":

                            %><jsp:include page="include/ControllerClientesAlterar.jsp"/><%
                            break;

                        case "listar":

                            %><jsp:include page="include/ControllerClientesListar.jsp"/><%
                            break;
